...
@interface ScanQRCodeViewController ()<SGScanCodeDelegate, UINavigationControllerDelegate, UIImagePickerControllerDelegate> {
    SGScanCode *scanCode;
}
...
- (void)scanCode:(SGScanCode *)scanCode result:(NSString *)result {
    ...
    if (self.fetchScanQRCodeResult) {
        self.fetchScanQRCodeResult(result);
    }
}
